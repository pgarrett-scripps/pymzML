...
__NAMESPACE__ = "http://psi.hupo.org/schema_revision/mzML_0.99.12"
...
class CvlistType:
    ...
    cv: list[Cvtype] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://psi.hupo.org/schema_revision/mzML_0.99.12",
            "min_occurs": 1,
        },
    )
...
class PrecursorType:
    ...
    :ivar external_native_id: For precursor spectra that are external to
        this document which can be referenced by nativeID, this string
        must correspond to the 'nativeID' attribute of a spectrum in the
        external document indicated by 'sourceFileRef'.
    :ivar external_spectrum_id: For precursor spectra that are external
        to this document which cannot be referenced by nativeID, this
        string must correspond to the 'id' attribute of a spectrum in
        the external document indicated by 'sourceFileRef'.
    """
