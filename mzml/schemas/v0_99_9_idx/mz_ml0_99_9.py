...
__NAMESPACE__ = "http://psi.hupo.org/schema_revision/mzML_0.99.9"
...
class CvparamType:
    ...
    :ivar cv_ref: The short tag for the resource as defined in the
...
class SoftwareParamType:
    """
    :ivar cv_ref: The CV label for this CV term.
...
class CvlistType:
    ...
    cv: list[Cvtype] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://psi.hupo.org/schema_revision/mzML_0.99.9",
            "min_occurs": 1,
        },
    )
...
class ScanType(ParamGroupType):
    ...
    :ivar instrument_configuration_ref: This attribute must reference
        the 'id' attribute of the appropriate InstrumentType.
    """
...
class AcquisitionSettingsType(ParamGroupType):
    ...
    :ivar source_file_list: List with the source files containing the
...
class InstrumentConfigurationType(ParamGroupType):
    """
    Description of the actual configuration of the different components of the mass
    spectrometer that are used for an analysis.
...
class RunType(ParamGroupType):
    ...
    :ivar instrument_configuration_ref: This attribute must reference
        the 'id' of the appropriate InstrumentType.
