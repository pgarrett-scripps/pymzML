...
from mzml.schemas.v1_1_2_idx.mz_ml1_1_0 import MzMl

__NAMESPACE__ = "http://psi.hupo.org/ms/mzml"


class IndexTypeName(Enum):
    SPECTRUM = "spectrum"
...
class IndexType:
    ...
    name: Optional[IndexTypeName] = field(
        default=None,
        metadata={
            "type": "Attribute",
            "required": True,
...
class IndexListType:
    """
    :ivar index: Index element containing zero or more offsets for
